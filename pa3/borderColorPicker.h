...
class borderColorPicker : public colorPicker
{
  ...
  private:
    unsigned int border; // Number of pixels to use for border
    HSLAPixel color;     // Color used for the border
    PNG im;                 // Image used in flood fill algorithm
    double tol;        // Tolerance used in flood fill algorithm
};
